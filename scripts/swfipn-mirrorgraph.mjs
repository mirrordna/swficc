...
const mappings = [
  ...
  },
  {
    ...
    modules: ["SWFI page data", "buyer entities", "seller entities", "amount", "dates", "record link"],
    status: "live",
  ...
  },
  {
    ...
    modules: ["SWFI page data", "institution", "summary", "amount", "dates", "record link"],
    status: "live",
  ...
  },
  {
    ...
    modules: ["SWFI page data", "contact fields", "geography", "record link"],
