...
const routes = [
  ...
  { path: "/profiles/", mode: "protected", label: "Institutions" },
  { path: "/people/", mode: "protected", label: "People" },
  { path: "/transactions/", mode: "protected", label: "Transactions" },
  { path: "/mandates/", mode: "protected", label: "RFPs / Mandates" },
  { path: "/reports/", mode: "public", required: ["Reports Intelligence", "AUM Rankings", "Data source: SWFI records"] },
  { path: "/search/", mode: "protected", label: "Smart Search Bar" },
  { path: "/research/", mode: "protected", label: "Research / News" },
];
